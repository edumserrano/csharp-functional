...
namespace HttpResultMonad.Tests.HttpResultWithValueAndErrorMonad.Equality
{
    ...
    {
        [Fact]
        public void Inequality_operator_between_two_ok_HttpResultWithValueAndError_is_false_if_the_value_are_equal()
        {
            var result1 = HttpResult.Ok<string, string>("abc");
            var result2 = HttpResult.Ok<string, string>("abc");
            var result3 = HttpResult.Ok<string, string>("abc", Test.CreateHttpStateA());
            var result4 = HttpResult.Ok<string, string>("abc", Test.CreateHttpStateB());
        ...
        [Fact]
        public void Inequality_operator_between_two_fail_HttpResultWithValueAndError_is_false_if_the_error_are_equal()
        {
            var result1 = HttpResult.Fail<string, string>("abc");
            var result2 = HttpResult.Fail<string, string>("abc");
            var result3 = HttpResult.Fail<string, string>("abc", Test.CreateHttpStateA());
            var result4 = HttpResult.Fail<string, string>("abc", Test.CreateHttpStateB());
            var isDifferent1 = result1 != result2;
            var isDifferent2 = result3 != result4;
            isDifferent1.ShouldBeFalse();
            isDifferent2.ShouldBeFalse();
