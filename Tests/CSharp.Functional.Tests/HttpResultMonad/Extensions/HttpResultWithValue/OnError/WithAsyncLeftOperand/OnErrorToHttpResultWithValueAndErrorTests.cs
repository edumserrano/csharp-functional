...
using CSharp.Functional.HttpResultMonad.Extensions.HttpResultWithValue.OnError;
using Shouldly;
using Xunit;

namespace CSharp.Functional.Tests.HttpResultMonad.Extensions.HttpResultWithValue.OnError.WithAsyncLeftOperand
{
