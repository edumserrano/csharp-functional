...
using HttpResultMonad.Extensions.HttpResultWithValueAndError.OnSuccess;
using Shouldly;
using Xunit;

namespace CSharp.Functional.Tests.HttpResultMonad.Extensions.HttpResultWithValueAndError.OnSuccess.WithAsyncRightOperand
{
