...
namespace ResultMonad.Extensions.HttpResultMonad.Tests.ResultWithValueAndError.OnSuccess
{
    public class OnSuccessToHttpResultWithValueAndErrorTests_OnSuccessFunc_From_TValue_To_KValue
    {
        [Fact]
